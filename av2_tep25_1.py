...
def quiz(): # ERRO CORRIGIDO: Indentação e 'def' adicionados
    ...
    for i, pergunta in enumerate(perguntas, 1):
        ...
        if acertou:
            ...
            print(f"Errado. A resposta correta é {pergunta['correta']})\n") # ERRO CORRIGIDO: O f-string não estava fechado corretamente.
    ...
    print(f"\nVocê acertou {score} de {len(perguntas)} perguntas.") # ERRO CORRIGIDO: 'prin' para 'print'
